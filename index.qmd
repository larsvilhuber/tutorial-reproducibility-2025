...
> The results cover multiple workshops, and include all responses between `r format(QUALTRICS_DAY1_STIME, "%d %B %Y")` and `r (QUALTRICS_DAY2_ETIME, "%d %B %Y")`.
...
> The results cover multiple workshops, and include all responses between `r format(QUALTRICS_DAY2_STIME, "%d %B %Y")` and `r (QUALTRICS_DAY2_ETIME, "%d %B %Y")`.
