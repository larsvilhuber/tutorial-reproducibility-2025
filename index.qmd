...
QUALTRICS_DAY1_STIME <- "2025-01-02 23:59:00"
QUALTRICS_DAY2_STIME <- "2025-01-02 23:59:00"
...
data <- data.raw |>
        ...
        #filter(as.Date(StartDate) > as.Date(QUALTRICS_DAY1_STIME)) |>
  # renaming variables
...
data2 |>
  ...
  summarise(Frequency=n()) |>
  ungroup() |>
  mutate(Percent = round(Frequency/nrow(data)*100,2)) -> data2.table
